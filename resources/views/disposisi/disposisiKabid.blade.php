                                    ...
                                    <tr style="border-bottom:1px solid #dee2e6;">
                                        ...
                                        <td>
                                            @if ($dispo)
                                                ...
                                                <small
                                                    class="text-muted">{{ $dispo->pemberi->bidang->nama_bidang ?? 'Kepala Kantor' }}</small>
                                            @endif
                                        </td>
                                        <td
                ...
                <div class="modal-content border-0 shadow rounded-4">
                    ...
                    <div class="modal-body p-4">
                                    ...
                                    <div>
                                        @if ($surat->prioritas == 'Tinggi')
                                            <span class="badge bg-danger px-3 py-2"
                                                style="width:110px;font-size:0.85rem;">Tinggi</span>
                                        @elseif($surat->prioritas == 'Sedang')
                                            <span class="badge bg-warning text-dark px-3 py-2"
                                                style="width:110px;font-size:0.85rem;">Sedang</span>
                                        @else
                                            <span class="badge bg-success px-3 py-2"
                                                style="width:110px;font-size:0.85rem;">Rendah</span>
                                        @endif
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="text-secondary small">Tanggal Verifikasi</div>
                                    <div>{{ \Carbon\Carbon::parse($surat->tanggal_verifikasi)->format('d M Y H:i') }}
                                    </div>
                                </div>
                            </div>
                        </div>
                        @if ($surat->jenis_surat == 'Undangan')
                            <hr>
                            <div class="mb-4">
                                <div class="text-uppercase text-secondary small fw-semibold mb-3"> Informasi Kegiatan
                                </div>
                                <div class="row g-4">
                                    <div class="col-md-4">
                                        <div class="text-secondary small">Tanggal Surat</div>
                                        <div>{{ \Carbon\Carbon::parse($surat->tanggal_kegiatan)->format('d M Y') }}
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                            ...
                            <div class="border rounded-3 p-3 mb-4 d-flex position-relative">
                                ...
                                <div class="col-6 ps-4 position-relative">
                                    ...
                                    <div class="fw-bold mb-3 text-dark">
                                        {{ \Carbon\Carbon::parse($surat->tanggal_kegiatan)->format('d-m-Y') }}</div>

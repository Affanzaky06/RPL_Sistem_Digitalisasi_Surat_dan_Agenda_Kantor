                    ...
                    <table class="table table-hover mb-0 text-center align-middle">
                        ...
                        <tbody>
                            @forelse ($daftarPegawai as $pegawai)
                                            ...
                                            <div class="modal-body pt-2 px-4 pb-4">
                                                ...
                                                <div class="row mb-4">
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" class="form-control border-dark"
                                                            value="{{ $pegawai->id_bidang }}" disabled>
                                                    </div>
                                                    <div class="col-md-6 mt-3 mt-md-0">
                                                        <label class="form-label text-dark fw-medium">Jabatan</label>
                                                        <input type="text" class="form-control border-dark"
                                                            value="{{ $pegawai->id_jabatan }}" disabled>
                                                    </div>
                                                </div>
                                                ...
                                                @else
                                                    <div
                                                        ...
                                                        <i class="bi bi-file-earmark-x fs-2"></i><br><small>Tidak ada berkas
                                                            diunggah</small>
                                                    </div>
                                                @endif
                                            </div>
                                ...
                                <div class="modal fade" id="editModal{{ $pegawai->nip }}" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-lg">
                                        <div class="modal-content border-dark rounded-3">
                                            <div class="modal-header border-bottom-0 pb-0">
                                            ...
                                            <form action="{{ route('kepegawaian.update', $pegawai->nip) }}" method="POST"
                                                ...
                                                <div class="modal-body pt-2 px-4 pb-0">
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-md-6">
                                                            <label class="form-label text-dark fw-medium">NIP</label>
                                                            <input type="text" name="nip" class="form-control border-dark"
                                                    ...
                                                    <div class="mb-3">
                                                        <label class="form-label text-dark fw-medium">Nama Lengkap</label>
                                                        <input type="text" name="nama" class="form-control border-dark"
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-md-6">
                                                            ...
                                                            <select name="bidang" class="form-select border-dark" required>
                                                                ...
                                                                @foreach($semuaBidang as $bidang)
                                                                    <option value="{{ $bidang->id_bidang }}" {{ $pegawai->id_bidang == $bidang->id_bidang ? 'selected' : '' }}>
                                                                        {{ $bidang->nama_bidang }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                        ...
                                                        <div class="col-md-6 mt-3 mt-md-0">
                                                            <label class="form-label text-dark fw-medium">Jabatan</label>
                                                            <select name="jabatan" class="form-select border-dark" required>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="border border-dark rounded-3 p-3 text-center bg-light">
                                                            <input type="file" name="berkas_pegawai"
                                                                ...
                                                                accept=".pdf,.jpg,.jpeg">
                                                            <small class="text-muted d-block mt-1">Biarkan kosong jika tidak
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="text-center py-4 text-muted">Tidak ada data pegawai ditemukan.
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>

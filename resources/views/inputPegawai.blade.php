                ...
                <form action="{{ route('kepegawaian.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="nip" value="{{ old('nip') }}"
                                class="form-control border-dark border @error('nip') is-invalid @enderror"
                                placeholder="Contoh: 192501051999001334" required inputmode="numeric" pattern="[0-9]*"
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="email" name="email" class="form-control border-dark border"
                                autocomplete="off" placeholder="Contoh: pegawai@kantor.com">
                        </div>
                        <div class="col-md-6 mt-3 mt-md-0">
                            <label class="form-label text-dark fw-medium">No. Telepon <span
                                    class="text-secondary small">(Opsional)</span></label>
                            <input type="text" name="no_telp" class="form-control border-dark border"
                                placeholder="Contoh: 08123456789" inputmode="numeric" pattern="[0-9]*"
                                autocomplete="off" oninput="this.value=this.value.replace(/[^0-9]/g,'')">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <select id="bidang" name="bidang" class="form-select border-dark border shadow-sm"
                                required>
                        ...
                        <div class="col-md-6 mt-3 mt-md-0">
                            ...
                            <select id="jabatan" name="jabatan" class="form-select border-dark border shadow-sm"
                                required>
                    ...
                    <div class="mb-4">
                        <label class="form-label text-dark fw-medium">Unggah Berkas KK, Pas Foto</label>
                        <div class="border border-dark rounded-3 p-4 text-center position-relative"
                            ...
                            <input id="file-upload" type="file" class="d-none" name="berkas_pegawai"
                                accept=".pdf,.jpg,.jpeg">
                        </div>
                    </div>
                    ...
                    <div class="text-end mb-0">
                        <button type="submit" class="btn btn-primary px-5 fw-bold"
                            style="background-color: #0d6efd;">Simpan</button>
                    </div>
                </form>
            </div>

        ...
        <div class="col-lg-8">
            ...
            <div class="card shadow-sm mb-3 border-secondary-subtle rounded-3">
                <div class="card-body position-relative">
                    ...
                    <p class="card-text text-muted mb-3" style="font-size: 0.9rem;">Rapat Koordinasi Kamis, 10-10-2026,
                        10:00, Kantor Bupati</p>
                    <button class="btn btn-dark btn-sm rounded-pill px-4">Detail</button>
                </div>
            </div>
            ...
            <div class="card shadow-sm mb-3 border-secondary-subtle rounded-3">
                <div class="card-body position-relative">
                    <button type="button" class="btn-close position-absolute top-0 end-0 m-3"style="font-size: 10px;"
                        aria-label="Close"></button>

                    <h6 class="card-title fw-semibold">
                        <i class="bi bi-info-circle"></i> Laporan Disposisi
                    </h6>
                    <p class="card-text text-muted mb-3" style="font-size: 0.9rem;">Kabid A berhalangan hadir,
                        Musyawarah Desa C</p>
                    <button class="btn btn-dark btn-sm rounded-pill px-4">Detail</button>
                </div>
            </div>
